document.addEventListener('DOMContentLoaded', () => {
            ...
            const DOMElements = {
                ...
                feelsLike: document.getElementById('feels-like'), // Corrected: Refers to the number span
                feelsLikeUnit: document.getElementById('feels-like-unit'), // Corrected: Refers to the unit span
            ...
            const updateAllTemperatures = () => {
                ...
                // EDITED JAVASCRIPT: Correctly targets the separate spans
            ...
            const fetchWeatherData = async (lat, lon) => {
                ...
                try {
                    ...
                    // This ensures the loading screen is removed even if there's an error
